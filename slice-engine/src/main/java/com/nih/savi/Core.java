...
public class Core {
	...
	private static int numOfCores = 1024;
	private static String outputPath = "/Users/noulehoilemos2/Desktop/test/";
	private static String outputName = "results_TF_1171_set";
	private static String bbPath = "/Users/noulehoilemos2/Desktop/test/1171_set.txt";
	private static String sliceFilepath = "/Users/noulehoilemos2/Desktop/test/TF_1171_v10.jslice";
	private static String sliceChemistryFolder = "/Users/noulehoilemos2/Desktop/test/TF_1171_v10.jslice";
	private static String lowerRating= "desactivated";
	private static String ghostMolecules = "activated";
	private static String inchikey= "desactivated";
	private static int size_limit_per_file = 0;
	private static int size_max = 0;
		...
		if (new File(sliceChemistryFolder).isFile()) {
			System.out.println("Chemistry filename: " + sliceChemistryFolder);
			  ...
			  Map<String,String> subtransformSmirks = sliceTester.getReactionSmirks();
				...
				//generate molecules
				int nb_files = 0;
				deleteOldFiles(outputPath+outputName);
				for (Entry<String, Map<String, List<IAtomContainer>>> e : compatibleMolecules.entrySet()) {
					...
					molMaker.setSize_max(size_max);
					molMaker.setSize_limit_per_file(size_limit_per_file);
					try {
				...
				for ( int i = 1; i <= nb_files; i++ ) {
					try {
						sliceTester.checkProducts(outputPath,outputName,i,sliceChemistryFolder,lowerRating,ghostMolecules,inchikey);
	...
	public static void setInchikey(String inchikey) { Core.inchikey = inchikey;}

	public static int getSize_max() { return size_max;}

	public static void setSize_max(int size_max) {Core.size_max = size_max;}

	public static int getSize_limit_per_file() { return size_limit_per_file;}

	public static void setSize_limit_per_file(int size_limit_per_file) {Core.size_limit_per_file = size_limit_per_file;}
