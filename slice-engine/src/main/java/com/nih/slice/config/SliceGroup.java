...
public class SliceGroup {
		...
		if (fg.equals(FunctionalGroup.FUNCTIONAL)) {
			for (FunctionalGroup fg2 : FunctionalGroup.values() ) {
				...
				for (String exp : smarts.split("\\|\\|")) {
					Pattern ptrn = SmartsPattern.create(exp, Smarts.FLAVOR_CACTVS);
					if (ptrn.matches(ac))
					{res.add(ptrn.matchAll(ac) ); }//System.out.println("smarts :"+exp);}
				}
			}
		}
		else {
	...
	public String getSmarts(FunctionalGroup group) {
		...
		String amine2="[C;X4;Z1:999][NH1;X3;Z0][C;Z1;X4]||[c;X3:999][NH1;X3;Z0][C;Z1;X4]||[c;X3:999][NH1;X3;Z0][c;X3]||[c;X3:999][nH1;X3;Z0][c;X3]||[c;X3][nH1;X3;Z0][c;X3:999]||[c;X3][NH1;X3;Z0][C;Z1;X4:999]";
