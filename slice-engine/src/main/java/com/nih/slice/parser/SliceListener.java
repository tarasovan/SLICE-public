...
public interface SliceListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SliceParser#set_current_ring_no_size}.
	 * @param ctx the parse tree
	 */
	void enterSet_current_ring_no_size(SliceParser.Set_current_ring_no_sizeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SliceParser#set_current_ring_no_size}.
	 * @param ctx the parse tree
	 */
	void exitSet_current_ring_no_size(SliceParser.Set_current_ring_no_sizeContext ctx);
	/**
