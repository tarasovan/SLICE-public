//adaped form https://github.com/kyleiwaniec/Basic-Algorithms-in-JAVA/blob/master/Calculator.java
...
public class Calculator{
    ...
    public double calculate(String expr) throws IOException {
    	ArrayDeque ad = shunting(lex(expr));
        return evaluate(ad);
    }
