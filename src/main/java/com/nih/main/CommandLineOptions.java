...
public class CommandLineOptions {
    ...
    protected Options createSaviALaCarteOptions() {
        ...
        options.addOption("z"," maximum number of products per file", true, "maximum number of products per file");
        options.addOption("p"," number of products to display", true, "number of products to display");
