...
public interface SliceVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SliceParser#set_current_ring_no_size}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSet_current_ring_no_size(SliceParser.Set_current_ring_no_sizeContext ctx);
	/**
