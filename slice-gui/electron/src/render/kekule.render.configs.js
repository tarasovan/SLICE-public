...
/** @lends Kekule.Render.MoleculeDisplayConfigs# */
{
	...
	initProperties: function()
	{
		...
		//BEGIN
		this.addIntConfigProp('defAtomMappingMarkType', Kekule.Render.AtomMappingMarkRenderType.DEFAULT, {'enumSource': Kekule.Render.AtomMappingMarkRenderType});
		//END		
 ...
 * //BEGIN
 * @property {Float} atomMappingMarkFontSize Size of font to draw atom Mapping mark.
 * @property {Float} atomMappingMarkMargin Gap between atom Mapping mark center and node point.
 * //END
...
/** @lends Kekule.Render.LengthConfigs# */
{
	...
	initProperties: function()
	{
		...
		//BEGIN
		this.addFloatConfigProp('atomMappingMarkFontSize', /*7*/10);
		this.addFloatConfigProp('atomMappingMarkMargin', 8);
		//END
