...
/** @lends Kekule.ChemStructureNode# */
{
	...
	initProperties: function()
	{
		...
		//BEGIN
		this.defineProp('atomMappingNumber', {'dataType': DataType.INT,
		'getter': function() {return this.getPropStoreFieldValue('atomMappingNumber') || 0; }});
		//END
	...
	getStructureRelatedPropNames: function(/*$super*/)
	{
		...
		//END
		//BEGIN
		return this.tryApplySuper('getStructureRelatedPropNames')  /* $super() */.concat(['charge', 'radical','atomMapping']);
		//END
	},
	/**
	...
	doGetComparisonPropNames: function(/*$super, */options)
	{
		...
		if (options.method === Kekule.ComparisonMethod.CHEM_STRUCTURE)
		{
			...
			if (this._getComparisonOptionFlagValue(options, 'radical'))
				result.push('radical');
			//BEGIN
			if (this._getComparisonOptionFlagValue(options, 'atomMapping'))
				result.push('atomMapping');
			//END
			/*
...
/** @lends Kekule.MolecularFormula# */
{
	...
	initProperties: function()
	{
		...
		//BEGIN
		this.defineProp('atomMapping', {'dataType': DataType.INT, 'getter': function() { return this.getPropStoreFieldValue('atomMapping') || 0; } });
		//END
	},
	/** @private */
	...
	clear: function()
	{
		...
		try
		{
			...
			//BEGIN
			this.setAtomMappingNumber(null);
			//END
			this.setPropStoreFieldValue('sections', []);
			this.notifySectionsChanged();
		}
