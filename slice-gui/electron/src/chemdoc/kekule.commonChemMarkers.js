...
//BEGIN
/**
 * Represent a atom mapping marker (number) in rendering parent chem object.
 * @class
 * @augments Kekule.ChemMarker.ChemPropertyMarker
 * @param {String} id Id of this node.
 * @param {Hash} coord2D The 2D coordinates of marker, {x, y}, can be null.
 * @param {Hash} coord3D The 3D coordinates of marker, {x, y, z}, can be null.
 */
 Kekule.ChemMarker.AtomMapping = Class.create(Kekule.ChemMarker.ChemPropertyMarker,
	/** @lends Kekule.ChemMarker.AtomMapping# */
	{
		/** @private */
		CLASS_NAME: 'Kekule.ChemMarker.AtomMapping',
		/** @ignore */
		getPropertyName: function()
		{
			return 'atomMapping';
...
/** @lends Kekule.ChemStructureNode# */
{
	...
	/**
	 * Get atom mapping marker of node. If no such a marker currently and canCreate is true, a new marker will be created.
	 * @returns {Kekule.ChemMarker.ChemPropertyMarker}
	 */
	 fetchAtomMappingMarker: function(canCreate, defProps)
	 {
		 return this.fetchMarkerOfType(Kekule.ChemMarker.AtomMapping, canCreate, false, defProps);
	 }
	 //END
});
