  ...
  addElseIf_: function () {
    ...
    this.appendValueInput("IF" + this.elseIfCount_)
      ...
      .setCheck([
        "_and_or_if",
        ///"_and_or",
        "_main_logic_structure",
        "selected_appendage",
        "Boolean",
        "_logic_compare"
      ])
      .appendField(Blockly.Msg["CONTROLS_IF_MSG_ELSEIF"]);
    this.setPreviousStatement(true, ["_if", "_foreach", "comment"]);
    this.setNextStatement(true, ["_if", "_foreach", "comment"]);
...
const controlsIfHelper = function () {
  ...
  this.getInput("DO0").fieldRow[0].value_ = "then";
  this.getInput("DO0").setCheck([
    "_if",
    "_foreach",
    "comment",
    "_kill",
